...
def process_customer_sale(inventory_list):
    ...
    while buying_more:
        ...
        chosen_id = ask_for_number("Enter the ID of the medicine to sell or 0 to stop: ", 0)
        ...
        if sale_mode == 1:
            ...
            if how_many > selected_med['qty_in_stock']:
                print(f"Sorry, we only have {selected_med['qty_in_stock']} tablets left.")
                continue
            ...
            if total_tabs_needed > selected_med['qty_in_stock']:
                strips_left = selected_med['qty_in_stock'] // selected_med['tabs_per_strip']
            ...
            if how_many >= 2:
                ...
                print(f"** Huhh Awesome! 5% discount applied. Saved Rs. {money_saved} **")
